...
|---|---|---|
| Ventana de 24 h | Se abre con cada mensaje **o llamada** del cliente y se reinicia con cada uno ✔ | Se registra `last_inbound_at` (PR #57). Todo envío responde a un mensaje entrante salvo la alerta al dueño (H-6), que **desde el 2026-09-12 consulta la ventana del dueño** antes de salir (decisión 4 de §16) |
