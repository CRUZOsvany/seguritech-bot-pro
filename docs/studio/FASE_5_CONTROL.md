...
| Simulador viejo (`/simulator/<uuid>`) | Conservaba el gate de siempre | Usaba su propia copia de la orquestación (H-2). Se retiró el 2026-09-11: la ruta redirige a `/app` |
