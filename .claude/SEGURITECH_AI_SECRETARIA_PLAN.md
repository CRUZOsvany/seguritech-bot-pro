...
>
> **⏸️ PAUSADO 2026-08-20 (decisión de producto, no técnica).** El owner decide enfocar el esfuerzo en explotar al máximo el motor de flows determinista (13 tipos de nodo v23.0, hoy subutilizados: sin búsqueda de catálogo por texto libre, sin horario real, sin test cases de gate) y en cumplimiento Meta (ventana de 24h, opt-out real — hoy sin implementar) **antes** de retomar este plan. Razón explícita: el negocio necesita ser el mejor en flows/WhatsApp primero; la IA se retoma cuando eso esté sólido. El ticket 1.2 de abajo ya tiene código real (ver nota en su fila) pero no se avanza a 1.3/1.4 hasta reabrir este plan deliberadamente.
>
