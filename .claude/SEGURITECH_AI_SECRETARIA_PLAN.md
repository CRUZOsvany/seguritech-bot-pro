...
| 1.2 | `IntentRouterPort` + implementación con Haiku | Test unitario con mensajes reales de un tenant piloto (papelería, cerrajería) clasificando correctamente flow vs. agente |
